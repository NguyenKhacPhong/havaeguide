        ...
        <div class="card-body">
            <form action="{{route('admin.major.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="major_name" id="name">
                    @error('major_name')
                ...
                <div class="form-group">
                    ...
                    <textarea name="major_description" class="form-control" id="major_description" cols="30" rows="5"></textarea>
                </div>
                <div class="form-group">
